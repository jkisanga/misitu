...
namespace Misitu.Web
{
    public class MisituSettingProvider: SettingProvider
    {
        public override IEnumerable<SettingDefinition> GetSettingDefinitions(SettingDefinitionProviderContext context)
        {
            return new[]
                   {
                new SettingDefinition(EmailSettingNames.Smtp.Host, "mail.nature-reserves.go.tz ", scopes: SettingScopes.Application | SettingScopes.Tenant),
                new SettingDefinition(EmailSettingNames.Smtp.Port, "25",scopes: SettingScopes.Application | SettingScopes.Tenant),
                ...
                new SettingDefinition(EmailSettingNames.Smtp.EnableSsl, "false", scopes: SettingScopes.Application | SettingScopes.Tenant),
