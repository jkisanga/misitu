...
$(document).ready(function(){
  ...
  setTimeout(function() {noty({text: '<strong>Hello! Welcome...</strong>',layout:'bottomRight',type:'information',timeout:15000});}, 7000);

  setTimeout(function() {noty({text: 'This is an all in one Forest Management Information System',layout:'bottomRight',type:'alert',timeout:13000});}, 9000);
