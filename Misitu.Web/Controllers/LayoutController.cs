...
using Abp.Threading;
using Misitu.Sessions;
using Misitu.Web.Models.Layout;

namespace Misitu.Web.Controllers
{
    public class LayoutController : MisituControllerBase
    {
        ...
        [ChildActionOnly]
        public PartialViewResult SideMenuItem(string activeMenu = "")
        {
            var model = new TopMenuViewModel
            {
                MainMenu = AsyncHelper.RunSync(() => _userNavigationManager.GetMenuAsync("MainMenu", AbpSession.ToUserIdentifier())),
            ...
            return PartialView("_SideMenuItem", model);
        }
